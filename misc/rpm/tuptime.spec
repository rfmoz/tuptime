...
getent passwd tuptime >/dev/null || adduser --system --gid tuptime --home-dir "/var/lib/tuptime" --shell '/sbin/nologin' --comment 'Tuptime execution user' tuptime > /dev/null
...
cp -R %{_topdir}/BUILD/%{name}-%{version}/README.md %{buildroot}%{_docdir}/tuptime/
