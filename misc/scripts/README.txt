...
tuptime_join.py
    Join two tuptime db files into another one.
...
tuptime-plot1.py
    Graph a plot with the number of hours (default) or events (-x switch)
...
tuptime-plot2.py
    ...
    or accumulated events per hour (-x switch). It gets the info from
